...
function HeroSection() {
  return (
    <div className="py-10 md:py-0 dark:bg-black bg-white  dark:bg-grid-small-white/[0.2] bg-grid-small-black/[0.2] relative flex items-center justify-center">
      <div className=" h-auto md:h-[40rem] w-full rounded-sm flex flex-col items-center justify-center relative overflow-hidden mx-auto ">
        <Spotlight
          className="top-40 left-0 md:left-50 sm:-top-20"
          fill="green"
        />

        <div className="p-4 relative z-10 w-full text-left md:pl-48">
          <h2 className="mt-12  font-bold text-base md:text-2xl text-neutral-300  mx-auto p-1">
            Hi There&#44; I&apos;m
          </h2>
          <h1 className=" md:mt-1 text-3xl md:text-6xl font-bold bg-clip-text text-transparent bg-gradient-to-b from-neutral-50 to-neutral-400">
            Ajmeri Guniya
          </h1>
          <h2 className="text-lg md:text-3xl flex gap-3 sm:mt-8">
            I am into
